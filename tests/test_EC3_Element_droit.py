...
class TestTraction:
    ...
    def test_Npl_Rd(self):
        ...
        traction = Traction(A=1000, Anet=0, ass_cat_C=False, t=10, h=100, classe_acier="S235", classe_transv=1)
        assert traction._Npl_Rd[1] == 235 * si.kN
    
    def test_Nu_Rd(self):
        """Test le calcul de la résistance ultime en traction."""
        traction = Traction(A=1000, Anet=800, t=10, h=100, ass_cat_C=False, classe_acier="S235", classe_transv=1)
    ...
    def test_Nt_Rd_assemblage_cat_C(self):
        ...
        traction = Traction(A=1000, Anet=800, ass_cat_C=True, t=10, h=100, classe_acier="S235", classe_transv=1)
...
class TestCompression:
    ...
    def test_Nc_Rd(self):
        ...
        compression = Compression(A=1000, lo_y=2000, lo_z=3000, type_appuis="Encastré 1 côté", t=10, h=100, classe_acier="S235", classe_transv=3)
    ...
    def test_lamb(self):
        ...
        assert lamb_values['y'] == 138.56406460551017
        assert lamb_values['z'] == 2078.4609690826524
...
class TestCisaillement:
    ...
    def test_Vpl_Rd(self):
        ...
        cisaillement = Cisaillement(Av=500, t=10, h=100, classe_acier="S235", classe_transv=3)
