...
class Boulon(Element):
    def __init__(self, d: int, d0: int, qualite: float, verif_filetage: bool = False, filetage_EN1090: bool=True, *args, **kwargs):
    ...
    def pince_metal_boulon(self, trous_oblongs: bool=False, corrosion: bool=False):
...
class Soudure(Element):
    def __init__(self, gorge: int, l: int, retour_soudure: bool=False, alpha: int|float=90, *args, **kwargs):
    ...
    def cordon_frontal(self, Ned: int|float):
    ...
    def cordon_laterale(self, Ned: int|float):
    ...
    def cordon_oblique(self, alpha_cordon: int|float, Ned: int|float):
    ...
    def cordon_pieces_obliques(self, Ned: int|float):
    ...
    def critere_generale(self, FvEd: int|float, FaxEd: int|float) -> float:
    ...
    def soudure_discontinue(self, b: int, b1: int, t1: int, corrosion: bool=False):
        """_summary_
