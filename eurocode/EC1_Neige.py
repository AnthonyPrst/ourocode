...
class Snow(Building):
	def __init__(self, region_neige:str, exposition="normal", type_toit="2 versants", blocage=False, **kwargs):
	...
	def _zone(self):
		file = "\zone_neige.csv"
		self.df = self.__data_from_csv(file)
...
if __name__ == "__main__":
	Action_snow = Snow("79  Deux-Sèvres", blocage=True, h_bat=5, d_bat=15, b_bat=13.1, alphatoit=15)
